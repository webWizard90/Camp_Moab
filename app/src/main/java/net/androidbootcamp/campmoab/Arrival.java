...
public class Arrival extends AppCompatActivity {
    ...
    private String arrivalDateFromFB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create adapter that retrieves resource from values strings.xml and adapts list_item
        ArrayAdapter<CharSequence> arrayAdapter = ArrayAdapter.createFromResource(this,
                R.array.extraInfoOnArrival, R.layout.activity_list_item);
    ...
    private void handleWidgetsBasedOnReservations() {
        ...
        Log.v("today", formatDate);
        Log.v("1 + day", formatNewDate1);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    //if dates are found in the dateList unblue layoutCodes else blur keyCode, networkID, and networkPassword
