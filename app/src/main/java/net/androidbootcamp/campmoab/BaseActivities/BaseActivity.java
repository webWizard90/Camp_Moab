...
public class BaseActivity extends AppCompatActivity {
    ...
    private void showDropdownMenu(View anchor) {
        PopupMenu popupMenu = new PopupMenu(this, anchor, R.style.CustomPopupMenu);  // Create a popup menu
        ...
        if (UID != null) {
            firebaseHelper.checkIfAdmin(UID, new FirebaseHelperClass.AdminCheckCallback() {
                ...
                public void onAdminCheck(boolean adminStatus) {
                    ...
                    Log.d("BaseActivity", "isAdmin: " + isAdmin);
                }
            });
        } else {
            Log.e("BaseActivity", "No user is logged in.");
        }
    }
}
