...
public class CreateAcct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_create_acct);
        ...
        login = (Button) findViewById(R.id.loginAcc);
                                ...
                                if (user != null) {
                                    user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(CreateAcct.this, "Check Your Email To Verify Account", Toast.LENGTH_SHORT).show();
                                                updateUI(mFirstName, mLastName, mPhoneNum, mEmail);
                                                Log.d("CreateAcct", "Email Sent");
                                            } else {
                                                Toast.makeText(CreateAcct.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                                Log.e("CreateAcct", "Error Occurred during email verification: " + task.getException().getMessage());
                                            }
                                        }
                                    });
                                } else {
                                    Toast.makeText(CreateAcct.this, "Error Occurred: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    Log.e("CreateAcct", "Error Occurred, user is null");
                                }
                          } else {
                  ...
                  user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                      ...
                      public void onComplete(@NonNull Task<Void> task) {
                          if (task.isSuccessful()) {
                              ...
                              Toast.makeText(CreateAcct.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                              Log.d("CreateAcct", "Error Occurred: " + task.getException().getMessage());
                          }
                      }
                  });*/
              }
