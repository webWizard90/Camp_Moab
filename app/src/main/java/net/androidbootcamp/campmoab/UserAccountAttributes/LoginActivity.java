...
//VARIABLES CALLED
                ...
                fAuth.signInWithEmailAndPassword(mEmail, mPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.v(TAG, "Sign-in Failed: " + task.getException().getMessage());
    ...
    private void checkUserAccessLevel() {
        //Log.i("UID check user access level", uid);
        ...
        //if query child isAdmin = true move to admin page else move to main page
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    Log.v("Snapshot:", "Exists");
