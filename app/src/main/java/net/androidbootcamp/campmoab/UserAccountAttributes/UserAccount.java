...
public class UserAccount extends AppCompatActivity {
    ...
    private ImageView home, acctPhoto;
    ...
    StorageReference storageRef = storage.getReferenceFromUrl("gs://camp-moab.appspot.com");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user != null) {
            Log.v(TAG, "onCreate: user is not null");
            ...
            //Load Account Photo\\
            if (imageRef != null) {
                Log.i(TAG, "onCreate: imageRef is not null");
            ...
            reservations.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(UserAccount.this, Reservations.class);
            ...
            book.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(UserAccount.this, BookingActivity.class);
                    startActivity(intent);
                }
            });
        }
